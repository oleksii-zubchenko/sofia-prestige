...
$section_title = $lang_slug === 'en' ? 'BLOG' : 'БЛОГ';
$all_posts_text = $lang_slug === 'en' ? 'All articles' : 'Всі статті';

$posts_page_url = '';
if (function_exists('pll_get_post')) {
    $current_blog_page_id = $lang_slug === 'en' ? 22 : 20;
    $translated_id = pll_get_post($current_blog_page_id, $lang_slug);
    if ($translated_id) {
...
?>
    ...
    <section class="blog-section" data-blog-slider>
        <div class="container">
            <div class="blog-head">
